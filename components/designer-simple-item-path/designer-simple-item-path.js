                      ...
                      <div className="scarperForm scarperFormTwo">
                        <Form>
                          <FormGroup className="form-group">
                            <FormGroup className="form-group form-check form-switch p-0 mb-0">
                              <Button type="submit">
                                Extract Records <br /> Elements From
                              </Button>
                              <Label
                            ...
                            <div className="card">
                              ...
                              <div className="card-body">
                                ...
                                <FormGroup className="form-group">
                                  ...
                                  <Input
                                    type="text"
                                    placeholder="Write your preferred name for this element"
                                  />
                                </FormGroup>
                                <FormGroup className="form-group">
                                  ...
                                  <Input
                                    type="text"
                                    placeholder="Select or write the path of the singe element"
                                  />
                                ...
                                <FormGroup className="form-group">
                                  <Button type="submit">
                                    Element Sample/Preview
                                  </Button>
                                  <Input
                                    type="text"
                                    placeholder="Price: $478.00"
                                    disabled
                                  />
                                  <div className="btn_block">
                                    <button type="button" className="checkbox">
