import Newscriptcss from "./newscript.module.css";
...
function NewScript(props) {
  ...
  console.log(watch("code"), "testing");
  ...
  return (
    <>
      <InnerHeader />
      <section className={Newscriptcss.newProject}>
        <TopSearch />
        <div className={Newscriptcss.project_items}>
          <div className={Newscriptcss.table_responsive}>
          ...
          <div className={Newscriptcss.newProjectWrap}>
            <h3>
              You are almost done! Now create your ﬁrst extraction project.
            </h3>
            <Form>
              <FormGroup className={Newscriptcss.newFile}>
                <Label for="file">
                  <span onClick={toggle}>
                    <span>
                      <img src={"/images/icon20-hover.svg"} alt="Icon18Hover" />
                    </span>
                    <span className={Newscriptcss.input_text}>NEW SCRIPT</span>
                  </span>
                </Label>
              </FormGroup>
            </Form>
      ...
      >
        <ModalHeader className="inner-heading">
          ...
          <span className="modalTitle">New Script - Creation Panel</span>
        </ModalHeader>
        <ModalBody>
